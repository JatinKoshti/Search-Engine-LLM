...
Try more Langchain Streamlit Agent examples at [github.com/langchain-ai/streamlit-agent](http://github.com/langchain-ai/streamlit-agent).
"""
...
if api_key:
    ...
    if "messages" not in st.session_state:
        st.session_state["messages"] = [
            {"role" : "assistant" , "content" : "Hi, I am a chatbot who can search on the web. How can I assist you ?"}
        ]
